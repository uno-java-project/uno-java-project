...
public class GamePacket implements Serializable {
    ...
    public GamePacket(String userID, int mode, String message, ImageIcon image, UnoGame uno, int roomCount, int roomNum) {
        this.userID = userID;
        this.mode = mode;
